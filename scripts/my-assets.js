    ...
    recentTransactions: [
        {
            type: 'income',
            title: 'Receipt',
            description: 'From Amazon Platform',
            amount: '+$12,345.67',
        ...
        },
        {
            type: 'exchange',
            title: 'Exchange',
            description: 'USD exchanged to CNY',
            amount: '$5,000 → ¥32,500',
        ...
        },
        {
            type: 'income',
            title: 'Receipt',
            description: 'From Shopify Store',
            amount: '+€4,321.00',
        ...
        },
        {
            type: 'withdrawal',
            title: 'Withdrawal',
            description: 'To Bank of China Account',
            amount: '-¥50,000.00',
...
function generateCurrencyRow(currency) {
    // 只显示金额，不加 info 圆圈
    const usdTooltip = formatCurrency(currency.available, currency.code);
